...
class ModbusHandlerExceptions:
    ...
    class NoPortSpecifiedError(Exception):
        pass
    ...
    def NoPortSpecifiedErrorExc(self):
        raise self.NoPortSpecifiedError("Could not create modbus client because no port was specified")

    def RegsFIFOsHaveDifferentSizesExc(self):
        raise self.RegsFIFOsHaveDifferentSizes("Could not construct float from two uint16 registers")
    ...
    exceptionSwitcher = {
            ...
            "NotAListReturned":NotAListReturnedExc,
            "NoPortSpecifiedError":NoPortSpecifiedErrorExc,
            "RegsFIFOsHaveDifferentSizes":RegsFIFOsHaveDifferentSizesExc,
...
# exc = ModbusHandlerExceptions()
# exc.generateException(1)